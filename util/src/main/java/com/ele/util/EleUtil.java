...
public class EleUtil {
     ...
     * @return
     */
    public static boolean userHasOrder(User user, Integer orderId, OrderServiceImpl orderService) {
     ...
     * @return
     */
    public static boolean userIsLikeShop(User user, Integer shopId, UserServiceImpl userService) {
     ...
     * @return
     */
    public static boolean checkUserHasAddress(User user,Integer addressId,UserServiceImpl userService) {
